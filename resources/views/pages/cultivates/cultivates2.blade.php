      ...
      <template x-for="item in paginatedData" :key="item.id">
        <div class="h-full">
          ...
          <template x-if="!item.is_harvested">
            <div
              class="relative flex h-full flex-col justify-between rounded-sm border border-stroke bg-white dark:bg-brand-green-bg p-5 dark:border-strokedark shadow-default dark:bg-boxdark"
              :class="item.id == {{ session('fromPlot', 'null') }} ? 'dark:border-amber-500 border-amber-700' : ''">
